<template>
  <v-app>
    <v-app-bar app width="100%" height="80px" class="px-8" dark color="#1A232E">
      <v-container fluid class="d-flex align-center">
        <div class="logoBlock d-flex align-center">
          <v-img
            alt="logo"
            width="112px"
            height="40px"
        ...
        <div class="menuBlock d-flex align-center ml-3 justify-lg-start px-4">
          <a href="" class="text-decoration-none">Home</a>
          <a href="" class="text-decoration-none">Store</a>
          <a href="" class="text-decoration-none">Channels</a>
          <a href="" class="text-decoration-none white--text font-weight-bold"
            >Categories</a
          >
          <a href="" class="text-decoration-none">My Stuff</a>
        </div>
        <div class="authBlock d-flex justify-end align-center">
          <v-btn
            color="#0f79af"
            class="font-font-weight-thin py-4 px-5"
            width="122"
            >Try for Free</v-btn
          >
          <v-btn color="#f2f4f6e6" x-small icon
            ><v-icon dense>fa-light fa-search</v-icon></v-btn
          >
        </div>
      </v-container>
    </v-app-bar>
    ...
    <v-footer color="#222"><FooterComp /> </v-footer>
  </v-app>
</template>
...
import ChannelsComp from "./components/ChannelsComp.vue";
import FireTv from "./components/FireTv.vue";
import FamilyFriendly from "./components/FamilyFriendly.vue";
